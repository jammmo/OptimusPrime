...
import speakmywords
import sys
sys.path.append(r'C:\Users\Guers\Documents\Python\Python Projects\Optimus Prime\Hack WPI-4c4fd8726f5b.json')
...
def get_quote(sentence):
    ...
    if discourage is True:
        disc = load_quotes('discouraging file2.txt')
        rand = random.randrange(len(disc))
        quote = disc[rand]
    else:
        #get quote info
        encourage = load_quotes('encouraging file2.txt')
...
get_quote('I will hit someone and hurt them.')
